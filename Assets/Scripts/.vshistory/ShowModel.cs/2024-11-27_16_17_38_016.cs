...
public class ShowModel : MonoBehaviour
{
    ...
    private IEnumerator CR_ShowModelsFrameWise()
    {
        ...
        while (true)
        {
            ...
            var cal = gaussianSplatAssets.Count / 30;
            cal=cal/gaussianSplatAssets.Count;
            yield return new WaitForSeconds((gaussianSplatAssets.Count/30)/gaussianSplatAssets.Count);
